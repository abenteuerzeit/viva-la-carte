...
namespace VLC.Data.Migrations
{
    ...
    [Migration("20230102211326_RecipeFull")]
    partial class RecipeFull
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VLC.Models.Recipes.Photo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VLC.Models.Recipes.Images", b =>
                {
                    b.HasOne("VLC.Models.Recipes.Photo", "Large")
                        .WithMany()
                        .HasForeignKey("LargeId");

                    b.HasOne("VLC.Models.Recipes.Photo", "Regular")
                        .WithMany()
                        .HasForeignKey("RegularId");

                    b.HasOne("VLC.Models.Recipes.Photo", "Small")
                        .WithMany()
                        .HasForeignKey("SmallId");

                    b.HasOne("VLC.Models.Recipes.Photo", "Thumbnail")
                        .WithMany()
